...
public class LeilaoSteps {
	...
	public void preenche_o_formulario_com_dados_validos() {
		this.leiloesPage = this.novoLeilaoPage.preencheForm("PC Novo", "1500", "04/09/2020");
	}
	...
	@Entao("o nov leilao aparece na tabela")
	public void o_nov_leilao_aparece_na_tabela() {
		this.leiloesPage.existe("PC Novo", "1500", "04/09/2020", "fulano");
		this.browser.clean();
	}
